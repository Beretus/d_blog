...
class Comment(models.Model):
    ...
    #likeComment = models.ManyToManyField('LikeComment', related_name='comment_likes')
...
class LikePost(models.Model):
    ...
    post = models.ForeignKey('Post', on_delete=models.SET_NULL, null=True)  # Dodaj to pole 
